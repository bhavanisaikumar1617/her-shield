    ...
    return (
      <PageTransition>
        <div className="flex min-h-96 items-center justify-center">
          <LoadingSpinner label="Loading admin profile..." size="lg" />
        </div>
      </PageTransition>
    )
  }
    ...
    <PageTransition>
      <section className="mx-auto max-w-4xl space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold text-[#0B3D91]">Admin Profile</h1>
            <p className="mt-1 text-sm text-slate-600">Manage your admin profile, password, and session.</p>
          </div>
          <div className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700">admin account</div>
        </div>
        ...
        <Motion.form onSubmit={handleSave} className="grid gap-4">
          <div>
        ...
        <Motion.form onSubmit={handleChangePassword} className="grid gap-4 rounded-xl border border-slate-200 p-5">
          ...
          <div>
            <label htmlFor="currentPassword" className="mb-1 block text-sm font-medium text-slate-700">Current Password</label>
            <input
              id="currentPassword"
